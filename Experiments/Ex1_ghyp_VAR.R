...
#K-test for Pareto optimal model
plot(fact,type="l")
lines(VaRP,col="red")
...
p.value
## Best model GGplot2
#p3<-qplot(1:length(fact),fact,geom = "line", main="VaR for GARCH", xlab="Time in days", ylab="Yeilds", ylim=c(-0.2,0.2));
